...
function EmptyState() {
    return (jsxRuntime.jsxs("div", { className: "flex-1 flex flex-col items-center justify-center gap-2 text-gray-400 text-sm text-center p-6", children: [jsxRuntime.jsx("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round", className: "w-12 h-12 opacity-30", children: jsxRuntime.jsx("path", { d: "M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" }) }), jsxRuntime.jsx("span", { children: "Comece uma conversa \u2014 n\u00F3s respondemos normalmente em algumas horas." })] }));
}
function Widget({ config }) {
    ...
    const apiRef = React.useRef(new ApiClient(config.publicKey));
...
function CrmSdk({ workspaceId, publicKey }) {
    ...
    const config = React.useMemo(() => ({ workspaceId, publicKey }), [workspaceId, publicKey]);
    React.useEffect(() => {
