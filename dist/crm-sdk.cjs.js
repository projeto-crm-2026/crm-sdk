...
// ── Icons ────────────────────────────────────────────────────────────────────
function ChatIcon() {
    return (jsxRuntime.jsx("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", className: "w-7 h-7 pointer-events-none", children: jsxRuntime.jsx("path", { d: "M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" }) }));
}
function CloseIcon({ size = 20 }) {
    return (jsxRuntime.jsxs("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2.5", strokeLinecap: "round", style: { width: size, height: size }, className: "pointer-events-none", children: [jsxRuntime.jsx("line", { x1: "18", y1: "6", x2: "6", y2: "18" }), jsxRuntime.jsx("line", { x1: "6", y1: "6", x2: "18", y2: "18" })] }));
}
function SendIcon() {
    return (jsxRuntime.jsx("svg", { viewBox: "0 0 24 24", fill: "currentColor", className: "w-[18px] h-[18px] pointer-events-none", children: jsxRuntime.jsx("path", { d: "M2.01 21L23 12 2.01 3 2 10l15 2-15 2z" }) }));
}
function AgentIcon() {
    return (jsxRuntime.jsx("svg", { viewBox: "0 0 24 24", fill: "currentColor", className: "w-5 h-5", children: jsxRuntime.jsx("path", { d: "M12 12c2.7 0 4.8-2.1 4.8-4.8S14.7 2.4 12 2.4 7.2 4.5 7.2 7.2 9.3 12 12 12zm0 2.4c-3.2 0-9.6 1.6-9.6 4.8v2.4h19.2v-2.4c0-3.2-6.4-4.8-9.6-4.8z" }) }));
}
// ── Helpers ──────────────────────────────────────────────────────────────────
...
function MessageBubble({ message, visitorId, isNew }) {
    ...
    return (jsxRuntime.jsxs("div", { className: `flex flex-col max-w-[80%] ${isNew ? 'animate-msg-in' : ''} ${isVisitor ? 'self-end' : 'self-start'}`, children: [jsxRuntime.jsx("div", { className: `px-3.5 py-2.5 rounded-2xl text-sm leading-relaxed break-words ${isVisitor
                    ? 'bg-blue-600 text-white rounded-br-sm'
                    : 'bg-white text-gray-800 rounded-bl-sm shadow-sm'}`, children: message.content }), jsxRuntime.jsx("div", { className: `text-[10px] text-gray-400 mt-1 px-1 ${isVisitor ? 'self-end' : ''}`, children: formatTime(message.created_at) })] }));
}
function TypingIndicator() {
    return (jsxRuntime.jsxs("div", { className: "flex items-center gap-1 px-3 py-2.5 bg-white rounded-2xl rounded-bl-sm self-start shadow-sm", children: [jsxRuntime.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-blue-400 animate-bounce-dot" }), jsxRuntime.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-blue-400 animate-bounce-dot-2" }), jsxRuntime.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-blue-400 animate-bounce-dot-3" })] }));
}
function LoadingSkeleton() {
    return (jsxRuntime.jsxs("div", { className: "flex flex-col gap-2.5 p-4 flex-1 bg-gray-50", children: [jsxRuntime.jsx("div", { className: "h-9 w-[55%] rounded-2xl animate-shimmer bg-gradient-to-r from-gray-100 via-gray-200 to-gray-100 bg-[length:200%_100%]" }), jsxRuntime.jsx("div", { className: "h-9 w-[75%] self-end rounded-2xl animate-shimmer bg-gradient-to-r from-gray-100 via-gray-200 to-gray-100 bg-[length:200%_100%]" }), jsxRuntime.jsx("div", { className: "h-9 w-[60%] rounded-2xl animate-shimmer bg-gradient-to-r from-gray-100 via-gray-200 to-gray-100 bg-[length:200%_100%]" })] }));
}
function EmptyState() {
    return (jsxRuntime.jsxs("div", { className: "flex-1 flex flex-col items-center justify-center gap-2 text-gray-400 text-sm text-center p-6", children: [jsxRuntime.jsx("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round", className: "w-12 h-12 opacity-30", children: jsxRuntime.jsx("path", { d: "M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" }) }), jsxRuntime.jsx("span", { children: "Start a conversation \u2014 we typically reply in minutes." })] }));
}
function Widget({ config }) {
    ...
    const [agentName, setAgentName] = React.useState('Suporte');
    const [agentAvatar, setAgentAvatar] = React.useState(null);
    const [newMessageIds, setNewMessageIds] = React.useState(new Set());
    React.useRef(0);
    const sessionRef = React.useRef(null);
    const apiRef = React.useRef(new ApiClient(config.publicKey, config.apiUrl));
    ...
    const connectWs = React.useCallback((session) => {
        var _a, _b, _c, _d;
    ...
    React.useEffect(() => { scrollToBottom(); }, [messages, showTyping, scrollToBottom]);
    ...
    // ── Render ────────────────────────────────────────────────────────────────
    return (jsxRuntime.jsxs("div", { className: "fixed bottom-3 right-3 z-[2147483645] flex flex-col items-end", children: [jsxRuntime.jsxs("div", { className: [
                ...
                ].join(' '), style: { boxShadow: isOpen ? '0 8px 32px rgba(0,0,0,0.18), 0 2px 8px rgba(0,0,0,0.10)' : 'none' }, role: "dialog", "aria-label": "Chat", "aria-hidden": !isOpen, children: [jsxRuntime.jsxs("div", { className: "bg-blue-600 text-white px-4 py-3.5 flex items-center gap-2.5 flex-shrink-0 select-none", children: [jsxRuntime.jsx("div", { className: "w-9 h-9 rounded-full bg-blue-400 flex items-center justify-center flex-shrink-0 overflow-hidden", children: agentAvatar
                                    ? jsxRuntime.jsx("img", { src: agentAvatar, alt: agentName, className: "w-full h-full object-cover" })
                                    : jsxRuntime.jsx(AgentIcon, {}) }), jsxRuntime.jsxs("div", { className: "flex-1 min-w-0", children: [jsxRuntime.jsx("div", { className: "text-[15px] font-semibold truncate", children: agentName }), jsxRuntime.jsxs("div", { className: "text-xs opacity-85 flex items-center gap-1", children: [jsxRuntime.jsx("span", { className: "inline-block w-1.5 h-1.5 rounded-full bg-green-400" }), "Online"] })] }), jsxRuntime.jsx("button", { onClick: () => setIsOpen(false), className: "p-1 rounded-lg opacity-80 hover:opacity-100 hover:bg-white/15 transition-all flex items-center justify-center", "aria-label": "Close chat", type: "button", children: jsxRuntime.jsx(CloseIcon, { size: 20 }) })] }), isLoading ? (jsxRuntime.jsx(LoadingSkeleton, {})) : (jsxRuntime.jsxs("div", { className: "flex-1 overflow-y-auto p-4 flex flex-col gap-2.5 bg-gray-50 scroll-smooth", role: "log", "aria-live": "polite", children: [messages.length === 0 ? (jsxRuntime.jsx(EmptyState, {})) : (messages.map((msg, idx) => {
                                var _a, _b;
                                const key = (_a = msg.id) !== null && _a !== void 0 ? _a : `msg-${idx}`;
                                return (jsxRuntime.jsx(MessageBubble, { message: msg, visitorId: (_b = sessionRef.current) === null || _b === void 0 ? void 0 : _b.visitorId, isNew: newMessageIds.has(key) }, key));
                            })), showTyping && jsxRuntime.jsx(TypingIndicator, {}), jsxRuntime.jsx("div", { ref: messagesEndRef })] })), error && (jsxRuntime.jsx("div", { className: "px-3.5 py-2 bg-red-50 text-red-800 text-xs border-t border-red-100 text-center flex-shrink-0", role: "alert", children: error })), jsxRuntime.jsxs("div", { className: "p-3 bg-white border-t border-gray-100 flex gap-2 items-end flex-shrink-0", children: [jsxRuntime.jsx("textarea", { ref: inputRef, value: inputValue, onChange: handleInputChange, onKeyDown: handleKeyDown, placeholder: "Digite uma mensagem\u2026", rows: 1, className: "flex-1 min-h-[38px] max-h-[100px] px-3 py-2 border-[1.5px] border-gray-200 rounded-[20px] font-widget text-sm text-gray-800 bg-gray-50 resize-none outline-none focus:border-blue-400 focus:bg-white transition-colors placeholder:text-gray-400 overflow-y-auto leading-snug", "aria-label": "Message" }), jsxRuntime.jsx("button", { onClick: handleSend, disabled: isSending || !inputValue.trim(), className: "w-[38px] h-[38px] rounded-full bg-blue-600 text-white flex items-center justify-center flex-shrink-0 hover:bg-blue-400 active:scale-95 disabled:opacity-40 disabled:cursor-not-allowed transition-all", type: "button", "aria-label": "Send", children: jsxRuntime.jsx(SendIcon, {}) })] })] }), jsxRuntime.jsxs("button", { onClick: () => setIsOpen(prev => !prev), className: "w-14 h-14 rounded-full bg-blue-600 hover:bg-blue-400 text-white flex items-center justify-center shadow-xl active:scale-95 transition-all duration-200 relative outline-none flex-shrink-0", "aria-label": isOpen ? 'Close chat' : 'Open chat', type: "button", children: [jsxRuntime.jsx("span", { className: `absolute inset-0 flex items-center justify-center transition-all duration-200 ${isOpen ? 'opacity-100 scale-100' : 'opacity-0 scale-75'}`, children: jsxRuntime.jsx(CloseIcon, { size: 24 }) }), jsxRuntime.jsx("span", { className: `absolute inset-0 flex items-center justify-center transition-all duration-200 ${isOpen ? 'opacity-0 scale-75' : 'opacity-100 scale-100'}`, children: jsxRuntime.jsx(ChatIcon, {}) }), unreadCount > 0 && !isOpen && (jsxRuntime.jsx("span", { className: "absolute top-0.5 right-0.5 w-[18px] h-[18px] rounded-full bg-red-500 text-white text-[10px] font-bold flex items-center justify-center border-2 border-white pointer-events-none", children: unreadCount > 9 ? '9+' : unreadCount }))] })] }));
}
...
function CrmSdk({ workspaceId, publicKey, apiUrl, wsUrl }) {
    ...
    const config = React.useMemo(() => ({ workspaceId, publicKey, apiUrl, wsUrl }), [workspaceId, publicKey, apiUrl, wsUrl]);
    React.useEffect(() => {
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("div", { ref: hostRef, style: { position: 'contents' } }), portalTarget && reactDom.createPortal(jsxRuntime.jsx(Widget, { config: config }), portalTarget)] }));
}
...
function init(config) {
    ...
    const bootstrap = () => {
        ...
        container.className = 'font-widget';
        shadow.appendChild(container);
        client.createRoot(container).render(React.createElement(Widget, { config }));
    };
...
//# sourceMappingURL=crm-sdk.cjs.js.map
